...
MODEL                = TP_MBD3
MODULES              = rt_logging.c TP_MBD3.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/TP_MBD3.exe
MAKEFILE             = TP_MBD3.mk
...
SYSTEM_LIBS             = -L"C:\Program Files\MATLAB\R2022b\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwi18n.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib sf_runtime.lib libmwsl_solver_rtw.lib
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 0

#--------------------------- Model and reference models -----------------------
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TP_MBD3_ref.rsp
